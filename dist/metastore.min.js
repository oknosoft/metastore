!function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.Metastore=t()}(this,function(){function e(e){var t=document.createElement("div"),a=new dhtmlXGridObject(t);return t.classList.add("multi_checkbox"),e.container.appendChild(t),a.setIconsPath(dhtmlx.image_path),a.setImagePath(dhtmlx.image_path),a.setHeader(","+e.name||e.property.Заголовок||e.property.name),a.setInitWidths("30,*"),a.setColAlign("center,left"),a.setColSorting("na,na"),a.setColTypes("ch,ro"),a.setColumnIds("ch,name"),a.enableAutoWidth(!0,600,100),a.enableAutoHeight(!0,180,!0),a.init(),e.values?e.values.forEach(function(e){a.addRow(e.ref,[0,e.name])}):e.property.type.is_ref&&e.property.type.types&&1==e.property.type.types.length&&$p.md.mgr_by_class_name(e.property.type.types[0]).find_rows({owner:e.property},function(e){a.addRow(e.ref,[0,e.name])}),a}function t(e){function t(){noUiSlider.create(c,{start:[e.start?e.start.min:100,e.start?e.start.max:1e4],step:e.step||100,margin:e.margin||100,connect:!0,behaviour:"tap-drag",range:{min:e.range?e.range.min:200,max:e.range?e.range.max:1e4}}),c.noUiSlider.on("update",function(e,t){t?i.value=e[t]:r.value=e[t],a()})}function a(){var t={};t[e.name]=[parseInt(r.value)||0,parseInt(i.value)||1e5],e.on_change(t)}function n(){c.noUiSlider.set([r.value,i.value]),a()}var r,i,s=document.createElement("div"),l=document.createElement("div"),c=document.createElement("div");return e.container.appendChild(s),s.appendChild(l),l.style.marginBottom="12px",l.innerHTML=e.synonym+": <input name='min' /> - <input name='max' />",r=l.querySelector("[name=min]"),i=l.querySelector("[name=max]"),r.style.width="33%",i.style.width="33%",s.appendChild(c),t(),r.addEventListener("change",n),i.addEventListener("change",n),c.rebuild=function(a){a.range&&(e.range=a.range),a.start&&(e.start=a.start),c.noUiSlider.destroy(),t()},c}function a(e){function t(){n||(e.innerHTML='<p class="text">Пока нет ни одного комментария, ваш будет первым</p>',n=!0)}var a,n;t(),dhx4.attachEvent("socket_msg",function(t){t&&t.rows&&"opinion"==t.type&&t.rows.forEach(function(t){t.model==a&&(n&&(e.innerHTML="",n=!1),t.opinion.forEach(function(t){e.innerHTML+='<p class="text">'+t.pro+"</p>"}))})}),this.__define({model:{get:function(){return a},set:function(e){a!=e&&(a=e,t(),a&&$p.eve.socket.send({type:"opinion",model:a}))}}})}function n(){function e(e){return e.ФайлКартинки!=$p.blank.guid?"background-image:url(templates/product_pics/"+e.ФайлКартинки+".png);":""}function t(e){return e.Производитель!=$p.blank.guid?$p.cat.Производители.get(e.Производитель).presentation:""}function a(e){if((!e.Цена_Мин||!e.Цена_Макс)&&e.Характеристики){var t=JSON.parse(e.Характеристики);for(var a in t)(!e.Цена_Мин||t[a].Цена_Мин&&e.Цена_Мин>t[a].Цена_Мин)&&(e.Цена_Мин=t[a].Цена_Мин),(!e.Цена_Макс||t[a].Цена_Макс&&e.Цена_Макс<t[a].Цена_Макс)&&(e.Цена_Макс=t[a].Цена_Макс)}return e.Цена_Мин||(e.Цена_Мин=0),e.Цена_Макс||(e.Цена_Макс=0),(e.Цена_Мин==e.Цена_Макс?e.Цена_Мин.toFixed(0):"от "+e.Цена_Мин.toFixed(0)+" до "+e.Цена_Макс.toFixed(0))+' <i class="fa fa-rub" style="font-size: smaller; color: #747f7f"></i>'}function n(e){return a(e),(e.Цена_Макс*e.count).toFixed(0)+' <i class="fa fa-rub" style="font-size: smaller; color: #747f7f"></i>'}dhtmlx.Type.add(dhtmlXDataView,{name:"list",template:$p.injected_data["dataview_list.html"],template_loading:"Загрузка данных...",height:96,width:900,margin:2,padding:0,border:1,image:e,manufacturer:t,price:a}),dhtmlx.Type.add(dhtmlXDataView,{name:"cart",template:$p.injected_data["dataview_cart.html"],height:96,width:800,margin:2,padding:0,border:1,image:e,price:n}),dhtmlx.Type.add(dhtmlXDataView,{name:"large",template:$p.injected_data["dataview_large.html"],height:210,width:380,margin:2,padding:2,border:1,image:e,manufacturer:t,price:a}),dhtmlx.Type.add(dhtmlXDataView,{name:"small",template:$p.injected_data["dataview_small.html"],height:180,width:220,margin:2,padding:2,border:1,image:e,manufacturer:t,price:a}),dhtmlx.Type.add(dhtmlXDataView,{name:"viewed",template:$p.injected_data["dataview_viewed.html"],height:180,width:220,margin:2,padding:2,border:1,image:e,manufacturer:t,price:a})}dhtmlXCellObject.prototype.attachDynDataView=function(e,t){t||(t={});var a,n,r={type:t.type||{template:"#name#"},select:t.select||!0};return t.pager&&(r.pager=t.pager),t.hasOwnProperty("drag")&&(r.drag=t.drag),t.hasOwnProperty("select")&&(r.select=t.select),t.hasOwnProperty("multiselect")&&(r.multiselect=t.multiselect),t.hasOwnProperty("height")&&(r.height=t.height),t.hasOwnProperty("tooltip")&&(r.tooltip=t.tooltip),t.hasOwnProperty("autowidth")&&(r.autowidth=t.autowidth),t.selection||(t.selection={}),t.custom_css&&(Array.isArray(t.custom_css)||(t.custom_css=["list","large","small"]),t.custom_css.forEach(function(e){dhtmlXDataView.prototype.types[e].css=e})),t.container?(r.container=t.container,n=new dhtmlXDataView(r)):n=this.attachDataView(r),t.custom_css&&t.custom_css.length>1&&(dv_tools=new $p.iface.OTooolBar({wrapper:t.outer_container||this.cell,width:"86px",height:"28px",bottom:"2px",right:"28px",name:"dataview_tools",image_path:dhtmlx.image_path+"dhxdataview"+dhtmlx.skin_suffix(),buttons:t.buttons||[{name:"list",img:"dataview_list.png",title:"Список (детально)","float":"left"},{name:"large",img:"dataview_large.png",title:"Крупные значки","float":"left"},{name:"small",img:"dataview_small.png",title:"Мелкие значки","float":"left"}],onclick:function(e){var t=dhtmlXDataView.prototype.types[e];-1!=e.indexOf("list")?n.config.autowidth=1:n.config.autowidth=Math.floor(n._dataobj.scrollWidth/(t.width+2*t.padding+2*t.margin+2*t.border)),n.define("type",e)}})),n.__define({selection:{get:function(){},set:function(e){if("object"==typeof e)for(var a in e)t.selection[a]=e[a];this.lazy_timer()}},requery:{value:function(){t.url="",$p.rest.build_select(t,e),t.filter_prop&&(t.url+="&filter_prop="+JSON.stringify(t.filter_prop)),dhx4.isIE&&(t.url=encodeURI(t.url)),n.clearAll(),n._settings&&(n._settings.datatype="json"),n.load(t.url,"json",function(e){e&&n.show(n.first())}),a=0}},requery_list:{value:function(t){function a(){var e,a,i=[];t.forEach(function(t){e=r.get(t.ref||t,!1,!0),e&&(a={}._mixin(e._obj),a.id=e.ref,t.count&&(a.count=t.count),!a.Код&&e.id&&(a.Код=e.id),i.push(a))}),n.clearAll(),n.parse(i,"json")}var r=$p.md.mgr_by_class_name(e.class_name);return r.load_cached_server_array(t,e.rest_name).then(a)}},lazy_timer:{value:function(){a&&clearTimeout(a),a=setTimeout(n.requery,200)}}}),t.hash_route&&($p.eve.hash_route.push(t.hash_route),setTimeout(function(){t.hash_route($p.job_prm.parse_url())},50)),n},$p.iface.list_data_view=function(e){var t,a,n,r=document.createElement("div"),i=document.createElement("div"),s=document.createElement("div");return e.container instanceof dhtmlXCellObject?(t=document.createElement("div"),e.container.attachObject(t),t.style.width="100%",t.style.height="100%"):(t=e.container,delete e.container),t.appendChild(s),s.appendChild(i),r.classList.add("wb-tools"),s.style.clear="both",s.style.height=i.style.height=t.offsetHeight+"px",s.style.width=i.style.width=t.offsetWidth+"px",n={container:i,outer_container:s,type:e.type||"list",custom_css:e.custom_css||!0,autowidth:1,pager:{container:r,size:30,template:"{common.prev()}<div class='paging_text'> Страница {common.page()} из #limit#</div>{common.next()}"},fields:["ref","name"],select:e.select||!0},e.hide_pager&&delete n.pager,"list"==n.type||e.autowidth||delete n.autowidth,e.drag&&(n.drag=!0),a=dhtmlXCellObject.prototype.attachDynDataView({rest_name:"Module_ИнтеграцияСИнтернетМагазином/СписокНоменклатуры/",class_name:"cat.Номенклатура"},n),s.appendChild(r),a.attachEvent("onAfterSelect",function(e){}),a.attachEvent("onItemDblClick",function(e,t,n){for(var r,i={},s=0;s<t.target.classList.length;s++)if(0==t.target.classList.item(s).indexOf("dv_")){r=!0;break}return r||(r=$p.job_prm.parse_url(),i=i._mixin(a.get(e)),i.ref=i.id,i.id=i.Код,i._not_set_loaded=!0,delete i.Код,$p.cat.Номенклатура.create(i).then(function(t){$p.iface.set_hash(t.ВидНоменклатуры.ref,e,r.frm,"catalog")})),!1}),e.autosize&&window.addEventListener("resize",function(){setTimeout(function(){s.style.height=i.style.height=t.offsetHeight+"px",s.style.width=i.style.width=t.offsetWidth+"px",a.refresh()},600)},!1),a},dhtmlXDataView.prototype.get_elm=function(e){for(;e=e.parentNode;)if(e.getAttribute&&e.getAttribute("dhx_f_id"))return this.get(e.getAttribute("dhx_f_id"))},dhtmlXCellObject.prototype.attachPropFilter=function(a,n){function r(e){var t;for(var a in e){if(d[a]){if("object"==typeof e[a])for(var n in e[a])d[a][n]!=e[a][n]&&(t=!0)}else t=!0;d[a]=e[a]}t&&dhx4.callEvent("filter_prop_change",[d])}n||(n={});var i,s,l,c=this,o=c.getWidth?c.getWidth():c.cell.offsetWidth-44,d={},A=$p.job_prm.parse_url(),R=new function(){this.children=[],this.form=c.attachForm([{type:"settings",labelWidth:120,inputWidth:120,offsetLeft:"dhx_web"==dhtmlx.skin?4:8,offsetTop:8},{type:"container",name:"price",label:"",inputWidth:o,inputHeight:50,position:"label-top"},{type:"checkbox",name:"store",label:"Есть на складе",labelAlign:"left",position:"label-right",tooltip:"Скрыть тованы, которых нет в наличии"},{type:"container",name:"_add",label:"Дополнительно",inputWidth:o,inputHeight:"auto",position:"label-top"},{type:"template",name:"form_template_3",label:"Показать"},{type:"template",name:"form_template_1",label:"Больше параметров"}])};return i=R.form.getContainer("_add"),R.__define({mode:{get:function(){},set:function(e){},enumerable:!1},parent:{get:function(){return l?l.ref:""},set:function(n){var c,o={container:R.form.getContainer("price"),on_change:r,name:"Цена",synonym:"Цена",range:{min:0,max:1e6},start:{min:100,max:1e5}};for(R.children.forEach(function(e){e.destructor&&e.destructor()});c=i.lastChild;)i.removeChild(c);if(d={},n==$p.blank.guid)return void(s?(o.range.min=0,o.range.max=1e6,o.start.min=100,o.start.max=1e5,s.rebuild(o)):s=new t(o));if(l=a.get(n),o.range.min=l.Цена_Мин>500?l.Цена_Мин-500:0,o.range.max=l.Цена_Макс+500,o.start.min=l.Цена_Мин,o.start.max=l.Цена_Макс,s?s.rebuild(o):s=new t(o),l.Производители){var A=l.Производители.split(",");A.length>1&&(c=new e({container:i,property:{},name:"Производители",values:A.map(function(e){return $p.cat.Производители.get(e)})}),R.children.push(c))}l.РеквизитыБыстрогоОтбораНоменклатуры.each(function(t){t.property&&!t.property.empty()&&(c=new e({container:i,property:t.property,name:t.ПредставлениеРеквизита}),R.children.push(c))})},enumerable:!1},hash_route:{value:function(e){e.obj&&R.parent!=e.obj&&(R.parent=e.obj)}}}),$p.eve.hash_route.push(R.hash_route),setTimeout(function(){R.hash_route(A)},50),R},dhtmlXCellObject.prototype.attachOProductCard=function(e){function t(e){var t=i.nom=$p.cat.Номенклатура.get(e,!1);i.main.requery_short(t),t.is_new()?t.load().then(i.main.requery_long)["catch"]($p.record_log):i.main.requery_long(t)}function n(e){function t(e){r.innerHTML=i.title.innerHTML=e.НаименованиеПолное||e.name}function a(){dhx4.callEvent(this.name,[i.nom])}var n=e.querySelector(".product_img"),r=e.querySelector("[name=order_title]"),s=e.querySelector("[name=order_price]"),l=e.querySelector("[name=order_brand]"),c=new dhtmlXCarousel({parent:e.querySelector(".product_carousel"),offset_left:0,offset_top:0,offset_item:0,touch_scroll:!0});this.requery_short=function(e){t(e),s.innerHTML=dhtmlXDataView.prototype.types.list.price(e),n.src="templates/product_pics/"+e.ФайлКартинки.ref+".png",e.Файлы||(c.base.style.display="none",n.style.display=""),i.notes.model=e.МаркетИд},this.requery_long=function(e){var a=JSON.parse(e.Файлы||"[]");if(a.length){var r=[];c.forEachCell(function(e){r.push(e.getId())}),r.forEach(function(e){c.cells(e).remove()}),n.style.display="none",c.base.style.display="",a.forEach(function(e){r=c.addCell(),c.cells(r).attachHTMLString('<img class="aligncenter" style="height: 100%" src="templates/product_pics/'+e.ref+"."+e.ext+'" >')})}else c.base.style.display="none",n.style.display="";t(e),e.Марка!=$p.blank.guid?l.innerHTML="Марка (бренд): "+e.Марка.presentation:e.Производитель!=$p.blank.guid&&(l.innerHTML="Производитель: "+e.Производитель.presentation),e.ФайлОписанияДляСайта.empty()?i.description.style.display="none":(i.description.style.display="",$p.ajax.get("templates/product_descriptions/"+e.ФайлОписанияДляСайта.ref+".html").then(function(e){i.description.innerHTML=e.response})["catch"](function(t){$p.record_log(e.ФайлОписанияДляСайта.ref)})),i.head_layout||(i.head_layout=new dhtmlXLayoutObject({parent:i.properties,pattern:"1C",offsets:{top:8,right:0,bottom:0,left:0},cells:[{id:"a",text:"Свойства и категории",header:!1}]})),i.head_fields&&i.head_layout.cells("a").detachObject(!0),i.head_fields=i.head_layout.cells("a").attachHeadFields({obj:e}),i.head_fields.setEditable(!1),i.notes.model=e.МаркетИд},dhx4.attachEvent("layout_resize",function(e){$p.record_log("")}),["order_cart","order_compare"].forEach(function(t){e.querySelector("[name="+t+"]").onclick=a})}e||(e={}),this.attachHTMLString($p.injected_data["product_card.html"]),baron({root:".wdg_product_accordion",scroller:".scroller",bar:".scroller__bar",barOnCls:"baron",$:$,event:function(e,t,a,n){"trigger"==n&&(n="fire"),bean[n||"on"](e,t,a)}}).fix({elements:".header__title",outside:"header__title_state_fixed",before:"header__title_position_top",after:"header__title_position_bottom",clickable:!0}).pull({block:".load",elements:[{self:".load__value",property:"width"}],limit:115,onExpand:function(){$(".load").css("background","grey")}});var r=this.cell,i={container:r.querySelector(".wdg_product_accordion"),header:r.querySelector("[name=header]"),title:r.querySelector("[name=title]"),path:r.querySelector("[name=path]"),main:new n(r.querySelector("[name=main]")),description:r.querySelector("[name=description]"),properties:r.querySelector("[name=properties]"),notes:new a(r.querySelector("[name=notes]")),download:r.querySelector("[name=download]"),head_layout:null,head_fields:null};new $p.iface.CatalogPath(i.path,function(e){var t=$p.job_prm.parse_url();return $p.iface.set_hash(this.ref,"",t.frm,t.view),$p.cancel_bubble(e)});return new $p.iface.OTooolBar({wrapper:i.header,width:"28px",height:"29px",top:"0px",right:"20px",name:"back",class_name:"",buttons:[{name:"back",text:'<i class="fa fa-long-arrow-left fa-lg" style="vertical-align: 15%;"></i>',title:"Вернуться к списку","float":"right"}],onclick:function(e){switch(e){case"back":var t=$p.job_prm.parse_url();$p.iface.set_hash(t.obj,"",t.frm,t.view),$p.iface.popup&&$p.iface.popup.hide()}}}),$p.eve.hash_route.push(function(e){"catalog"==e.view&&$p.is_guid(e.ref)&&!$p.is_empty_guid(e.ref)&&t(e.ref)}),e.ref&&(t(e.ref),delete e.ref),i},dhtmlXCellObject.prototype.attachOProductsView=function(e){e||(e={});var t,a,n,r=this.cell,i=document.createElement("div");return this.attachObject(i),function(){var e=document.createElement("div"),a=document.createElement("div"),n=document.createElement("input"),r=document.createElement("i");e.className="md_column320",i.appendChild(e),"desktop"!=$p.device_type&&(e.style.padding="4px 8px"),t=new $p.iface.CatalogPath(e),a.className="search",e.appendChild(a),a.appendChild(n),a.appendChild(r),r.className="icon_search fa fa-search",n.className="search",n.type="search",n.placeholder="Введите артикул или текст",n.title="Найти товар по части наименования, кода или артикула",n.onchange=function(e){dhx4.callEvent("search_text_change",[this.value]),this.blur()}}(),function(){var e=document.createElement("div"),t=document.createElement("div"),a=['по возрастанию цены <i class="fa fa-sort-amount-asc fa-fw"></i>','по убыванию цены <i class="fa fa-sort-amount-desc fa-fw"></i>','по наименованию <i class="fa fa-sort-alpha-asc fa-fw"></i>','по наименованию <i class="fa fa-sort-alpha-desc fa-fw"></i>','по популярности <i class="fa fa-sort-numeric-asc fa-fw"></i>','по популярности <i class="fa fa-sort-numeric-desc fa-fw"></i>'];e.className="md_column320",i.appendChild(e),e.appendChild(t),$p.iface.ODropdownList({container:t,title:"Сортировать:"+("desktop"==$p.device_type?"<br />":" "),values:a,class_name:"catalog_path",event_name:"sort_change"}),dhx4.attachEvent("sort_change",function(e){$p.record_log(e)})}(),function(){function e(e){var t={}._mixin(a.get(e));return t.ref=t.id,t.id=t.Код,t._not_set_loaded=!0,delete t.Код,$p.cat.Номенклатура.create(t)}var t=document.createElement("div"),s=document.createElement("div"),l=document.createElement("div");i.appendChild(l),l.appendChild(s),t.classList.add("wb-tools"),l.style.clear="both",l.style.height=s.style.height=r.offsetHeight+"px",l.style.width=s.style.width=r.offsetWidth+"px",n={container:s,outer_container:l,type:"list",custom_css:!0,autowidth:1,pager:{container:t,size:30,template:"{common.prev()}<div class='paging_text'> Страница {common.page()} из #limit#</div>{common.next()}"},fields:["ref","name"],selection:{},hash_route:function(e){e.obj&&n.selection.ВидНоменклатуры!=e.obj&&(n.selection.ВидНоменклатуры=e.obj,a.lazy_timer())}},a=dhtmlXCellObject.prototype.attachDynDataView({rest_name:"Module_ИнтеграцияСИнтернетМагазином/СписокНоменклатуры/",class_name:"cat.Номенклатура"},n),dhx4.attachEvent("search_text_change",function(e){e?n.selection.text=function(){return"text like '%25"+e+"%25'"}:n.selection.hasOwnProperty("text")&&delete n.selection.text,a.lazy_timer()}),dhx4.attachEvent("filter_prop_change",function(e){n.filter_prop=e,a.lazy_timer()}),l.appendChild(t),a.attachEvent("onAfterSelect",function(e){}),a.attachEvent("onItemDblClick",function(t,a,n){var r=$p.job_prm.parse_url();return e(t).then(function(e){$p.iface.set_hash(r.obj,t,r.frm,r.view)}),!1}),dhx4.attachEvent("layout_resize",function(e){l.style.height=s.style.height=r.offsetHeight+"px",l.style.width=s.style.width=r.offsetWidth+"px",a.refresh()}),s.addEventListener("click",function(t){var n=t.target,r=a.get_elm(t.target);r&&(n.classList.contains("dv_icon_cart")?e(r.id).then(function(e){dhx4.callEvent("order_cart",[e])}):n.classList.contains("dv_icon_add_compare")?e(r.id).then(function(e){dhx4.callEvent("order_compare",[e])}):n.classList.contains("dv_icon_detail")&&a.callEvent("onItemDblClick",[r.id]))},!1)}(),a},$p.iface.CatalogPath=function(e,t){function a(e){if(n!=e.obj){n=e.obj;for(var a,i=$p.cat.ВидыНоменклатуры.path(n);a=r.lastChild;)r.removeChild(a);var s=document.createElement("span");for(i.length&&i[0].presentation?s.innerHTML='<i class="fa fa-folder-open-o"></i> ':s.innerHTML='<i class="fa fa-folder-open-o"></i> Поиск во всех разделах каталога',r.appendChild(s);a=i.pop();)r.children.length>1&&(s=document.createElement("span"),s.innerHTML=" / ",r.appendChild(s)),s=document.createElement("a"),s.innerHTML=a.presentation,s.ref=a.ref,s.href="#",s.onclick=t||function(e){var t=$p.job_prm.parse_url();return t.obj!=this.ref&&$p.iface.set_hash(this.ref,"",t.frm,t.view),$p.cancel_bubble(e)},r.appendChild(s)}}var n=void 0,r=document.createElement("div");r.className="catalog_path",e.appendChild(r),$p.eve.hash_route.push(a),setTimeout(function(){a($p.job_prm.parse_url())},50)},$p.settings=function(e,t){e.rest=!0,e.irest_enabled=!0,e.local_storage_prefix="webshop_",e.rest_path="/a/ut11/%1/odata/standard.odata/",e.zone=0,e.data_url="data/",e.create_tables=!0,e.create_tables_sql=$p.injected_data["create_tables.sql"],e.settings_url="settings.html",e.allow_post_message="*",e.use_ip_geo=!0,e.request_full_screen=!0,e.guest_name="АлхимовАА",e.guest_pwd="",e.additional_css=["templates/webshop.css","templates/webshop_ie_only.css"],e.skin="dhx_terrace",$p.eve.redirect=!0},$p.iface.oninit=function(){function e(){var e,t,a,r=$p.wsql.get_user_param("sidebar_items","object");if(r&&Array.isArray(r)&&r.length){a=[];for(var i in r)r[i][0]&&a.push($p.iface.sidebar_items[i])}else a=$p.iface.sidebar_items;if(document.body.removeChild(document.querySelector("#webshop_splash")),"desktop"==$p.device_type?($p.iface.main=new dhtmlXSideBar({parent:document.body,icons_path:dhtmlx.image_path+"dhxsidebar"+dhtmlx.skin_suffix(),width:110,template:"icons_text",items:a,offsets:{top:0,right:0,bottom:0,left:0}}),e=$p.iface.main.attachToolbar({icons_size:24,icons_path:dhtmlx.image_path+"dhxsidebar"+dhtmlx.skin_suffix(),items:[{type:"text",id:"title",text:"&nbsp;"},{type:"spacer"},{type:"text",id:"right",text:"[Город клиента и мантра магазина]"}]})):$p.iface.main=new dhtmlXSideBar({parent:document.body,icons_path:dhtmlx.image_path+"dhxsidebar"+dhtmlx.skin_suffix(),width:180,header:!0,template:"tiles",autohide:!0,items:a,offsets:{top:0,right:0,bottom:0,left:0}}),$p.iface.main.attachEvent("onSelect",function(a){"desktop"==$p.device_type&&e.setItemText("title",window.dhx4.template("<span style='font-weight: bold; font-size: 14px;'>#text#</span>",{text:this.cells(a).getText().text})),t=$p.job_prm.parse_url(),t.view!=a&&$p.iface.set_hash(t.obj,"",t.frm,a),$p.iface["view_"+a]($p.iface.main.cells(a))}),n(),setTimeout(function(){$p.iface.main.cells("compare")&&$p.iface.view_compare($p.iface.main.cells("compare")),$p.iface.main.cells("cart")&&$p.iface.view_cart($p.iface.main.cells("cart"))},50),t=$p.job_prm.parse_url(),t.view&&-1!=$p.iface.main.getAllItems().indexOf(t.view))setTimeout($p.iface.hash_route,10);else{var s=$p.wsql.get_user_param("last_hash_url","object");s?$p.iface.set_hash(s.obj,s.ref,s.frm,s.view||"catalog"):$p.iface.set_hash(t.obj,t.ref,t.frm,"desktop"==$p.device_type?"content":"catalog")}if($p.iface.main.getAttachedToolbar){var l,c=$p.iface.main.getAttachedToolbar();c&&$p.ipinfo.ipgeo().then(function(e){e.city&&e.city.name_ru?l=e.city.name_ru:e.region&&e.region.name_ru&&(l=e.city.region),c.setItemText("right",'<i class="fa fa-map-marker"></i> '+l.replace("г. ","")),c.objPull[c.idPrefix+"right"].obj.style.marginRight="8px"})}}$p.iface.sidebar_items=[{id:"catalog",text:"Каталог",icon:"search_48.png"},{id:"compare",text:"Сравнение",icon:"compare_48.png"},{id:"cart",text:"Корзина",icon:"shop_cart_48.png"},{id:"orders",text:"Заказы",icon:"projects_48.png"},{id:"content",text:"Контент",icon:"content_48.png"},{id:"user",text:"Профиль",icon:"contacts_48.png"},{id:"settings",text:"Настройки",icon:"settings_48.png"},{id:"about",text:"О программе",icon:"about_48.png"}],window.addEventListener("beforeunload",function(){$p.wsql.set_user_param("last_hash_url",$p.job_prm.parse_url())}),$p.eve.auto_log_in().then(e)["catch"](function(e){console.log(e)}).then(function(e){$p.iface.sync&&$p.iface.sync.close()})},$p.eve.hash_route.push(function(e){return e.view&&$p.iface.main.getActiveItem()!=e.view&&$p.iface.main.getAllItems().forEach(function(t){t==e.view&&$p.iface.main.cells(t).setActive(!0)}),!1}),$p.iface.view_catalog=function(e){function t(){$p.iface._catalog.filter||($p.iface._catalog.filter=$p.iface._catalog.navigation.cells("filter").attachPropFilter($p.cat.ВидыНоменклатуры))}function a(e,t){$p.iface._catalog.product_card||($p.iface._catalog.product_card=e.attachOProductCard({rest_name:"Module_ИнтеграцияСИнтернетМагазином/СвойстваНоменклатуры",class_name:"cat.Номенклатура",ref:t})),e.setActive()}function n(e){$p.iface._catalog.dataview||($p.iface._catalog.dataview=e.attachOProductsView())}function r(e){function t(e){a&&(e.obj||(e.obj=$p.blank.guid),a.selectItem(e.obj,!1,!1))}var a=e.attachDynTree($p.cat.ВидыНоменклатуры,{},function(){$p.cat.ПредопределенныеЭлементы.by_name("ВидНоменклатуры_ПоказыватьВМагазине").Элементы.each(function(e){a.openItem(e.Элемент.ref)})});return a.attachEvent("onSelect",function(e){var t=$p.job_prm.parse_url();t.obj!=e&&$p.iface.set_hash(e,"",t.frm,t.view)}),$p.eve.hash_route.push(t),setTimeout(function(){t($p.job_prm.parse_url())},50),a}function i(){$p.iface._catalog={},"desktop"==$p.device_type?($p.iface._catalog.layout=e.attachLayout({pattern:"2U",cells:[{id:"a",text:"Каталог",width:300,header:!1},{id:"b",text:"Товары",header:!1}],offsets:{top:0,right:0,bottom:0,left:0}}),$p.iface._catalog.layout.attachEvent("onResizeFinish",function(){dhx4.callEvent("layout_resize",[this])}),$p.iface._catalog.layout.attachEvent("onPanelResizeFinish",function(){dhx4.callEvent("layout_resize",[this])}),$p.iface._catalog.navigation=$p.iface._catalog.layout.cells("a").attachTabbar({arrows_mode:"auto",tabs:[{id:"tree",text:'<i class="fa fa-sitemap"></i> Разделы',active:!0},{id:"filter",text:'<i class="fa fa-filter"></i> Фильтр'}]}),$p.iface._catalog.carousel=$p.iface._catalog.layout.cells("b").attachCarousel({keys:!1,touch_scroll:!1,offset_left:0,offset_top:0,offset_item:0}),setTimeout(function(){n($p.iface._catalog.carousel.cells("dataview"))})):($p.iface._catalog.navigation=e.attachTabbar({arrows_mode:"auto",tabs:[{id:"tree",text:'<i class="fa fa-sitemap"></i> Разделы',active:!0},{id:"filter",text:'<i class="fa fa-filter"></i> Фильтр'},{id:"goods",text:'<i class="fa fa-search"></i> Товары'}]}),$p.iface._catalog.carousel=$p.iface._catalog.navigation.cells("goods").attachCarousel({keys:!1,touch_scroll:!1,offset_left:0,offset_top:0,offset_item:0})),$p.iface._catalog.carousel.hideControls(),$p.iface._catalog.carousel.addCell("dataview"),$p.iface._catalog.carousel.addCell("goods"),$p.iface._catalog.navigation.attachEvent("onSelect",function(e){return"filter"==e?t():"goods"==e&&n($p.iface._catalog.carousel.cells("dataview")),!0}),$p.iface._catalog.tree=r($p.iface._catalog.navigation.cells("tree")),$p.eve.hash_route.push(function(e){var t=$p.cat.Номенклатура.get(e.ref,!1,!0);"catalog"==e.view&&(t&&!t.empty()?(e.obj!=t.ВидНоменклатуры.ref&&(e.obj=t.ВидНоменклатуры.ref),e.obj!=$p.iface._catalog.tree.getSelectedItemId()&&$p.iface._catalog.tree.selectItem(e.obj,!1),a($p.iface._catalog.carousel.cells("goods"),e.ref)):!$p.cat.ВидыНоменклатуры.get(e.obj,!1,!0)||$p.cat.ВидыНоменклатуры.get(e.obj,!1,!0).empty()?$p.is_empty_guid($p.iface._catalog.tree.getSelectedItemId())||(e.obj=$p.iface._catalog.tree.getSelectedItemId()):$p.iface._catalog.carousel.cells("dataview").setActive())})}return $p.iface._catalog||i(),$p.iface._catalog},$p.iface.view_cart=function(e){function t(){function t(e){var t=parseInt(e.target.value),a=l.get_elm(e.target);return isNaN(t)?e.target.value=a.count:(a.count=t,o.sub(a.id,t)),!1}function a(e){var t=e.target,a=l.get_elm(e.target);a&&(t.classList.contains("dv_icon_plus")?o.add(a.id):t.classList.contains("dv_icon_minus")?o.sub(a.id):t.classList.contains("dv_input")&&setTimeout(function(){t.focus(),t.select(),t=null},300))}var n,r,i,s,l,c,o=this,d=e,A="view_cart",R=d.attachCarousel({keys:!1,touch_scroll:!1,offset_left:0,offset_top:0,offset_item:0});o.list=function(){var e=$p.wsql.get_user_param(A,"object");return Array.isArray(e)||(e=[],$p.wsql.set_user_param(A,e)),e},o.bubble=function(){var e=0;return o.list().forEach(function(t){e+=t.count}),e?d.setBubble(e):d.clearBubble(),e},o.add=function(e){if("string"==typeof e){if($p.is_empty_guid(e))return;e=$p.cat.Номенклатура.get(e,!1,!0)}if(e&&e.name){var t,a=o.list();for(var n in a)if(a[n].ref==e.ref){a[n].count++,t=!0;break}t||(a.push({ref:e.ref,count:1}),$p.msg.show_msg((e.НаименованиеПолное||e.name)+" добавлен в корзину")),$p.wsql.set_user_param(A,a),o.requery().then(function(){l.select(e.ref)})}},o.remove=function(e){var t=o.list();for(var a in t)if(t[a].ref==e||t[a].id==e)return void dhtmlx.confirm({type:"confirm",title:"Корзина",text:"Подтвердите удаление товара",ok:"Удалить",cancel:"Отмена",callback:function(e){e&&(t.splice(a,1),$p.wsql.set_user_param(A,t),o.requery())}})},o.sub=function(e,t){function a(){$p.wsql.set_user_param(A,n),o.requery().then(function(){l.select(e)})}var n=o.list();for(var r in n)if(n[r].ref==e||n[r].id==e)return void(t?(n[r].count=t,a()):void 0==t&&n[r].count>1?(n[r].count--,a()):o.remove(e))},o.requery=function(){var e={count:o.bubble(),amount:0};return l.requery_list(o.list()).then(function(){o.list().forEach(function(t){var a=$p.cat.Номенклатура.get(t.ref,!1,!0);e.amount+=t.count*a.Цена_Макс}),c.querySelector("[name=top1]").innerHTML=dhx4.template($p.injected_data["cart_order_top1.html"],e),c.querySelector("[name=top2]").innerHTML=dhx4.template($p.injected_data["cart_order_top2.html"],e),c.querySelector("[name=top3]").innerHTML=(.07*e.amount).toFixed(0)})},setTimeout(function(){R.hideControls(),R.addCell("cart"),R.addCell("checkout"),R.cells("cart").attachHTMLString($p.injected_data["cart.html"]),n=R.cells("cart").cell,n.firstChild.style.overflow="auto",i=n.querySelector(".md_column1300"),s=n.querySelector("[name=cart_dataview]"),c=n.querySelector("[name=cart_order]"),s.style.width=c.offsetLeft-4+"px",s.style.height=n.offsetHeight-s.offsetTop-20+"px",window.addEventListener("resize",function(){setTimeout(function(){var e=s.style,t=s.firstChild.style,a=s.firstChild.firstChild.style;e.width=t.width=a.width=c.offsetLeft-4+"px",e.height=t.height=a.height=n.offsetHeight-s.offsetTop-20+"px",l.refresh()},600)},!1),l=$p.iface.list_data_view({container:s,height:"auto",type:"cart",custom_css:["cart"],hide_pager:!0,autowidth:!0}),s.addEventListener("change",t,!1),s.addEventListener("click",a,!1),o.bubble(),c.onclick=function(e){return"A"==e.target.tagName||"order_order"==e.target.getAttribute("name")||-1!=e.path.indexOf(c.querySelector(".dv_icon_card"))?(R.cells("checkout").setActive(),$p.cancel_bubble(e)):void 0},R.cells("checkout").attachHTMLString($p.injected_data["checkout.html"]),r=R.cells("checkout").cell,baron({root:".wdg_product_checkout",scroller:".scroller",bar:".scroller__bar",barOnCls:"baron",$:$,event:function(e,t,a,n){"trigger"==n&&(n="fire"),bean[n||"on"](e,t,a)}}).fix({elements:".header__title",outside:"header__title_state_fixed",before:"header__title_position_top",after:"header__title_position_bottom",clickable:!0}).pull({block:".load",elements:[{self:".load__value",property:"width"}],limit:115,onExpand:function(){$(".load").css("background","grey")}}),new $p.iface.OTooolBar({wrapper:r.querySelector("[name=header]"),width:"28px",height:"29px",top:"0px",right:"20px",name:"back",class_name:"",buttons:[{name:"back",text:'<i class="fa fa-long-arrow-left fa-lg" style="vertical-align: 15%;"></i>',title:"Вернуться в корзину","float":"right"}],onclick:function(e){switch(e){case"back":R.cells("cart").setActive()}}}),r.querySelector("[name=billing_kind]").onclick=function(e){if("A"==e.target.tagName){var t;$("li",this).removeClass("active"),e.target.parentNode.classList.add("active");for(var a=0;a<e.target.classList.length;a++)if(0==e.target.classList.item(a).indexOf("logo-")){t=e.target.classList.item(a).replace("logo-","")+"-container";break}return $(".billing-system",this.querySelector(".billing-systems-container")).each(function(e,a){e.classList.contains(t)?e.classList.remove("hide"):e.classList.contains("hide")||e.classList.add("hide")}),e.preventDefault(),$p.cancel_bubble(e)}}},50),dhx4.attachEvent("order_cart",o.add)}var a;return $p.iface._cart||($p.iface._cart=new t),a||"cart"!=$p.job_prm.parse_url().view||setTimeout($p.iface._cart.requery,200),$p.iface._cart},$p.iface.view_compare=function(e){function t(){function t(e){var t=e.target,a=r.get_elm(e.target);a&&(t.classList.contains("dv_icon_cart")?dhx4.callEvent("order_cart",[a.id]):t.classList.contains("dv_icon_add_compare")?s.add(a.id,!0)&&s.requery():t.classList.contains("dv_icon_remove_viewed")&&s.remove(a.id,!0))}function a(e,t){function a(e){return $p.is_data_obj(e)?e.presentation:"boolean"==typeof e?e?"Да":"Нет":e instanceof Date?e.getHours()||e.getMinutes()?$p.dateFormat(e,$p.dateFormat.masks.date_time):$p.dateFormat(e,$p.dateFormat.masks.date):e||""}var n,r,i,l=[],c=" ,Цена,НаименованиеПолное,Артикул,Производитель".split(","),o=[],d=" ",A="ro",R="na",_="fld",p="desktop"==$p.device_type?"200":"150",C="100",f=e.attachGrid(),O=dhtmlXDataView.prototype.types.list.price;f.setDateFormat("%d.%m.%Y %H:%fld"),s.list("compare").forEach(function(e){n=$p.cat.Номенклатура.get(e),n.ВидНоменклатуры==t&&(l.push(n),d+=","+n.name,A+=",ro",R+=",na",_+=","+n.ref,p+=",*",C+=",100")}),f.setIconsPath(dhtmlx.image_path),f.setImagePath(dhtmlx.image_path),f.setHeader(d),f.setInitWidths(p),f.setColumnMinWidth(C),f.setColSorting(R),f.setColTypes(A),f.setColumnIds(_),f.enableAutoWidth(!0,1300,600),f.init();for(var m in c){
i=[],0==m?i.push(""):"НаименованиеПолное"==c[m]?i.push("Наименование"):i.push(c[m]);for(var H in l)n=l[H],0==m?i.push("<img class='compare_img' src='templates/product_pics/"+n.ФайлКартинки.ref+".png' >"):1==m?i.push("<span style='font-size: large'>"+O(n)+"</span>"):i.push(a(n[c[m]]));o.push(i)}t.НаборСвойств.extra_fields.find_rows({deleted:!1},function(e){i=[e.property.Заголовок||e.property.presentation];for(var t in l)n=l[t],r=!1,n.extra_fields.find_rows({property:e.property},function(e){return i.push(a(e.value)),r=!0,!1}),r||(e.property.type.types.length&&"boolean"==e.property.type.types[0]?i.push(a(!1)):i.push(""));o.push(i)}),f.parse(o,"jsarray")}function n(e){"compare"==e.view?(i||void 0===i)&&(s.requery(),i=!1):("catalog"!=e.view||$p.is_empty_guid(e.ref)||$p.cat.ВидыНоменклатуры.get(e.obj,!1,!0)&&!$p.cat.ВидыНоменклатуры.get(e.obj,!1,!0).empty()&&s.add(e.ref),s.bubble())}var r,i,s=this,l=e,c="view_compare_";s.add=function(e,t){function a(t){-1==n.indexOf(e)&&(n.push(e),$p.wsql.set_user_param(c+(t?"compare":"viewed"),n),r=!0)}if(!$p.is_empty_guid(e)){var n=s.list("viewed"),r=!1;if(a(),t){n=s.list("compare"),a(t);var l=$p.cat.Номенклатура.get(e,!1,!0);l&&(s.bubble(),$p.msg.show_msg((l.НаименованиеПолное||l.name)+" добавлен к сравнению"))}return r&&(i=!0),r}},s.remove=function(e,t){var a=s.list("compare"),n=a.indexOf(e);-1!=n&&(a.splice(n,1),$p.wsql.set_user_param(c+"compare",a)),t&&(a=s.list("viewed"),n=a.indexOf(e),-1!=n&&(a.splice(n,1),$p.wsql.set_user_param(c+"viewed",a))),s.requery()},s.list=function(e){var t=$p.wsql.get_user_param(c+e,"object");return Array.isArray(t)||(t=[],$p.wsql.set_user_param(c+e,t)),t},s.tabs=l.attachTabbar({arrows_mode:"auto",tabs:[{id:"viewed",text:'<i class="fa fa-eye"></i> Просмотренные',active:!0}]}),s.bubble=function(){s.list("compare").length?l.setBubble(s.list("compare").length):l.clearBubble()},s.requery=function(){var e,t=s.tabs.getAllTabs(),n=$p.cat.Номенклатура,i=s.list("compare").concat(s.list("viewed")).filter(function(e,t,a){return a.indexOf(e)==t});s.tabs.tabs("viewed").setActive();for(var l=0;l<t.length;l++)"viewed"!=t[l]&&s.tabs.tabs(t[l]).close();t=[],n.load_cached_server_array(i).then(function(){s.list("compare").forEach(function(a){e=n.get(a,!1),-1==t.indexOf(e.ВидНоменклатуры)&&t.push(e.ВидНоменклатуры)}),r.requery_list(s.list("viewed"))}).then(function(){t.forEach(function(e){s.tabs.addTab(e.ref,e.name),a(s.tabs.cells(e.ref),e)})}),s.bubble()},dhx4.attachEvent("order_compare",function(e){"object"==typeof e&&(e=e.ref),$p.is_empty_guid(e)||s.add(e,!0)&&s.requery()}),$p.eve.hash_route.push(n),setTimeout(function(){r=$p.iface.list_data_view({container:s.tabs.cells("viewed"),custom_css:["viewed"],type:"viewed",autosize:!0}),s.tabs.cells("viewed").cell.addEventListener("click",t,!1),n($p.job_prm.parse_url())},50)}return $p.iface._compare||($p.iface._compare=new t),$p.iface._compare},$p.iface.view_orders=function(e){function t(){function t(e){if("orders"==e.view){var t=$p.md.mgr_by_class_name(e.obj);t&&!$p.is_empty_guid(e.ref)&&t.form_obj(a.tabs.cells(a.tabs.getActiveTab()),e.ref)}}var a=this,n={url:""},r={hide_header:!0,hide_filter:!0,date_from:new Date("2012-01-01")};a.tabs=e.attachTabbar({arrows_mode:"auto",tabs:[{id:"orders",text:'<i class="fa fa-suitcase"></i> Заказы',active:!0},{id:"pays",text:'<i class="fa fa-money"></i> Оплаты'},{id:"shipments",text:'<i class="fa fa-shopping-bag"></i> Продажи'},{id:"balance",text:'<i class="fa fa-balance-scale"></i> Баланс'}]}),$p.cat.Контрагенты.find()?a.orders=$p.doc.ЗаказКлиента.form_list(a.tabs.cells("orders"),r):($p.rest.build_select(n,{rest_name:"Module_ИнтеграцияСИнтернетМагазином/СправочникиПользователя/",class_name:"cat.Пользователи"}),$p.ajax.get_ex(n.url,n).then(function(e){$p.eve.from_json_to_data_obj(e)}).then(function(e){a.orders=$p.doc.ЗаказКлиента.form_list(a.tabs.cells("orders"),r)})["catch"](function(e){$p.record_log(e)})),a.tabs.attachEvent("onSelect",function(e){return a[e]||("pays"==e?(a[e]=a.tabs.cells(e).attachTabbar({arrows_mode:"auto",tabs:[{id:"bank",text:'<i class="fa fa-university"></i> Банк'},{id:"card",text:'<i class="fa fa-credit-card"></i> Карта'},{id:"cache",text:'<i class="fa fa-money"></i> Наличные'},{id:"refunds",text:'<i class="fa fa-undo"></i></i> Возвраты'}]}),a[e].attachEvent("onSelect",function(t){return a[e+"_"+t]||("bank"==t?a[e+"_"+t]=$p.doc.ПоступлениеБезналичныхДенежныхСредств.form_list(a[e].cells(t),r):"card"==t?a[e+"_"+t]=$p.doc.ОперацияПоПлатежнойКарте.form_list(a[e].cells(t),r):"cache"==t?a[e+"_"+t]=$p.doc.ПриходныйКассовыйОрдер.form_list(a[e].cells(t),r):"refunds"==t&&(a[e+"_"+t]=$p.doc.РасходныйКассовыйОрдер.form_list(a[e].cells(t),r))),!0}),a[e].cells("bank").setActive()):"shipments"==e&&(a[e]=a.tabs.cells(e).attachTabbar({arrows_mode:"auto",tabs:[{id:"shipments",text:'<i class="fa fa-truck"></i> Отгрузки'},{id:"refunds",text:'<i class="fa fa-undo"></i></i> Возвраты'}]}),a[e].attachEvent("onSelect",function(t){return a[e+"_"+t]||("shipments"==t?a[e+"_"+t]=$p.doc.РеализацияТоваровУслуг.form_list(a[e].cells(t),r):"refunds"==t&&(a[e+"_"+t]=$p.doc.ВозвратТоваровОтКлиента.form_list(a[e].cells(t),r))),!0}),a[e].cells("shipments").setActive())),!0}),$p.eve.hash_route.push(t)}return $p.iface._orders||($p.iface._orders=new t),$p.iface._orders},$p.iface.view_settings=function(e){function t(){$p.iface._settings={},e.attachHTMLString($p.injected_data["settings.html"]),$p.iface._settings._cell=e.cell.querySelector(".dhx_cell_cont_sidebar"),$p.iface._settings._cell.style.overflow="auto",$p.iface._settings._form1=$p.iface._settings._cell.querySelector("[name=form1]"),$p.iface._settings._form2=$p.iface._settings._cell.querySelector("[name=form2]"),$p.iface._settings._form3=$p.iface._settings._cell.querySelector("[name=form3]"),$p.iface._settings.form1=new dhtmlXForm($p.iface._settings._form1.firstChild,[{type:"settings",labelWidth:80,position:"label-left"},{type:"label",labelWidth:320,label:"Тип устройства",className:"label_options"},{type:"block",name:"form_block_2",list:[{type:"settings",labelAlign:"left",position:"label-right"},{type:"radio",name:"device_type",labelWidth:120,label:'<i class="fa fa-desktop"></i> Компьютер',value:"desktop"},{type:"newcolumn"},{type:"radio",name:"device_type",labelWidth:150,label:'<i class="fa fa-mobile fa-lg"></i> Телефон, планшет',value:"phone"}]},{type:"template",label:"",value:"",note:{text:"Класс устройства определяется автоматически, но пользователь может задать его явно",width:320}},{type:"label",labelWidth:320,label:"Вариант оформления интерфейса",className:"label_options"},{type:"combo",inputWidth:220,name:"skin",label:"Скин",options:[{value:"dhx_web",text:"Web"},{value:"dhx_terrace",text:"Terrace"}]},{type:"template",label:"",value:"",note:{text:"Дополнительные свойства оформления можно задать в css",width:320}},{type:"label",labelWidth:320,label:"Адрес http сервиса 1С",className:"label_options"},{type:"input",inputWidth:220,name:"rest_path",label:"Путь",validate:"NotEmpty"},{type:"template",label:"",value:"",note:{text:"Можно указать как относительный, так и абсолютный URL публикации 1С OData. О настройке кроссдоменных запросов к 1С <a href='#'>см. здесь</a>",width:320}},{type:"label",labelWidth:320,label:"Значение разделителя публикации 1С fresh",className:"label_options"},{type:"input",inputWidth:220,name:"zone",label:"Зона",numberFormat:["0","",""],validate:"NotEmpty,ValidInteger"},{type:"template",label:"",value:"",note:{text:"Для неразделенной публикации, зона = 0",width:320}}]),$p.iface._settings.form2=new dhtmlXForm($p.iface._settings._form2.firstChild,[{type:"settings",labelWidth:80,position:"label-left"},{type:"label",labelWidth:320,label:"Доступные закладки",className:"label_options"},{type:"container",name:"views",inputWidth:320,inputHeight:300},{type:"template",label:"",value:"",note:{text:"Видимость и порядок закладок навигации",width:320}}]),$p.iface._settings.form3=new dhtmlXForm($p.iface._settings._form3.firstChild,[{type:"settings",labelWidth:80,position:"label-left"},{type:"button",name:"save",value:"Применить настройки",offsetTop:20}]),$p.iface._settings.grid=new dhtmlXGridObject($p.iface._settings.form2.getContainer("views")),$p.iface._settings.grid.setHeader(" ,Закладка"),$p.iface._settings.grid.setInitWidths("50,*"),$p.iface._settings.grid.setColumnMinWidth("40,200"),$p.iface._settings.grid.setColSorting("na,na"),$p.iface._settings.grid.setColTypes("ch,ro"),$p.iface._settings.grid.enableAutoWidth(!0,800,300),$p.iface._settings.grid.init();var t=$p.wsql.get_user_param("sidebar_items","object");t&&Array.isArray(t)&&t.length||(t=[],$p.iface.sidebar_items.forEach(function(e){t.push([1,e.text])})),$p.iface._settings.grid.parse(t,"jsarray"),$p.iface._settings.grid.cells(7,0).setDisabled(!0),$p.iface._settings.form1.checkItem("device_type",$p.wsql.get_user_param("device_type")),["zone","skin","rest_path"].forEach(function(e){$p.iface._settings.form1.setItemValue(e,$p.wsql.get_user_param(e))}),$p.iface._settings.form1.attachEvent("onChange",function(e,t,a){$p.wsql.set_user_param(e,t)}),$p.iface._settings.form3.attachEvent("onButtonClick",function(e){for(var a in t)t[a][0]=$p.iface._settings.grid.cells(parseInt(a)+1,0).isChecked()?1:0;$p.wsql.set_user_param("sidebar_items",t),location.reload()})}return $p.iface._settings||t(),$p.iface._settings},$p.iface.view_user=function(e){function t(){function t(){var e=$p.cat.ВнешниеПользователи.find(),t={hide_header:!0,hide_filter:!0};n.tabs.cells("main").attachHeadFields({obj:e}),n.tabs.cells("main").attachToolbar({icons_size:24,icons_path:dhtmlx.image_path+"dhxsidebar"+dhtmlx.skin_suffix(),items:[{type:"text",id:"title",text:"<span style='font-size: large'>Реквизиты автризации</span>"}]}),n.tabs.cells("contacts").attachTabular({obj:e.ОбъектАвторизации,ts:"КонтактнаяИнформация",read_only:!0}),$p.cat.Контрагенты.form_selection(n.tabs.cells("contractors"),t),$p.cat.КартыЛояльности.form_selection(n.tabs.cells("discounts"),t),$p.cat.КонтактныеЛицаПартнеров.form_selection(n.tabs.cells("persons"),t)}function a(e){if("user"==e.view){var t=$p.md.mgr_by_class_name(e.obj);t&&!$p.is_empty_guid(e.ref)&&t.form_obj(n.tabs.cells(n.tabs.getActiveTab()),e.ref)}}var n=this,r={url:""};n.tabs=e.attachTabbar({arrows_mode:"auto",tabs:[{id:"main",text:'<i class="fa fa-user"></i> Основное',active:!0},{id:"contacts",text:'<i class="fa fa-paper-plane-o"></i> Адрес, телефон'},{id:"contractors",text:'<i class="fa fa-university"></i> Контрагенты'},{id:"discounts",text:'<i class="fa fa-credit-card-alt"></i> Карты лояльности'},{id:"persons",text:'<i class="fa fa-reddit-alien"></i> Контактные лица'}]}),$p.cat.ВнешниеПользователи.find()?t():($p.rest.build_select(r,{rest_name:"Module_ИнтеграцияСИнтернетМагазином/СправочникиПользователя/",class_name:"cat.Пользователи"}),$p.ajax.get_ex(r.url,r).then(function(e){$p.eve.from_json_to_data_obj(e)}).then(t)["catch"](function(e){$p.record_log(e)})),$p.eve.hash_route.push(a)}return $p.iface._user||($p.iface._user=new t),$p.iface._user},$p.iface.view_content=function(e){function t(){$p.iface._content={},e.attachHTMLString($p.injected_data["content.html"]),e.cell.querySelector(".dhx_cell_cont_sidebar").style.overflow="auto"}return $p.iface._content||t(),$p.iface._content},$p.iface.view_about=function(e){function t(){$p.iface._about={},e.attachHTMLString($p.injected_data["about.html"]),e.cell.querySelector(".dhx_cell_cont_sidebar").style.overflow="auto"}return $p.iface._about||t(),$p.iface._about},$p.injected_data._mixin({"about.html":'<div class="md_column1300">\r\n    <h1><i class="fa fa-info-circle"></i> Интернет-магазин MetaStore</h1>\r\n    <p>Метамагазин - это веб-приложение с открытым исходным кодом, разработанное компанией <a href="http://www.oknosoft.ru/" target="_blank">Окнософт</a> на базе фреймворка <a href="http://www.oknosoft.ru/metadata/" target="_blank">Metadata.js</a> и распространяемое под <a href="http://www.oknosoft.ru/programmi-oknosoft/metadata.html" target="_blank">коммерческой лицензией Окнософт</a>.<br />\r\n        Исходный код и документация доступны на <a href="https://github.com/oknosoft/metastore" target="_blank">GitHub <i class="fa fa-github-alt"></i></a>.<br />\r\n        Приложение является веб-интерфейсом к типовым конфигурациям 1С (Управление торговлей 11.2, Комплексная автоматизация 2.0, ERP Управление предприятием 2.1) и реализует функциональность интернет-магазина для информационной базы 1С\r\n    </p>\r\n    <p>Использованы следующие библиотеки и инструменты:</p>\r\n\r\n    <h3>Серверная часть</h3>\r\n    <ul>\r\n        <li><a href="http://1c-dn.com/1c_enterprise/" target="_blank">1c_enterprise</a><span class="md_muted_color">, ORM сервер 1С:Предприятие</span></li>\r\n        <li><a href="http://www.postgresql.org/" target="_blank">postgreSQL</a><span class="md_muted_color">, мощная объектно-раляционная база данных</span></li>\r\n        <li><a href="https://nodejs.org/" target="_blank">node.js</a><span class="md_muted_color">, серверная программная платформа, основанная на движке V8 javascript</span></li>\r\n        <li><a href="http://nginx.org/ru/" target="_blank">nginx</a><span class="md_muted_color">, высокопроизводительный HTTP-сервер</span></li>\r\n    </ul>\r\n\r\n    <h3>Управление данными в памяти браузера</h3>\r\n    <ul>\r\n        <li><a href="https://github.com/agershun/alasql" target="_blank">alaSQL</a><span class="md_muted_color">, база данных SQL для браузера и Node.js с поддержкой как традиционных реляционных таблиц, так и вложенных JSON данных (NoSQL)</span></li>\r\n        <li><a href="https://github.com/metatribal/xmlToJSON" target="_blank">xmlToJSON</a><span class="md_muted_color">, компактный javascript модуль для преобразования XML в JSON</span></li>\r\n        <li><a href="https://github.com/SheetJS/js-xlsx" target="_blank">xlsx</a><span class="md_muted_color">, библиотека для чтения и записи XLSX / XLSM / XLSB / XLS / ODS в браузере</span></li>\r\n    </ul>\r\n\r\n    <h3>UI библиотеки и компоненты интерфейса</h3>\r\n    <ul>\r\n        <li><a href="http://dhtmlx.com/" target="_blank">dhtmlx</a><span class="md_muted_color">, кроссбраузерная библиотека javascript для построения современных веб и мобильных приложений</span></li>\r\n        <li><a href="https://github.com/leongersen/noUiSlider" target="_blank">noUiSlider</a><span class="md_muted_color">, легковесный javascript компонент регулирования пары (min-max) значений </span></li>\r\n        <li><a href="https://github.com/eligrey/FileSaver.js" target="_blank">filesaver.js</a><span class="md_muted_color">, HTML5 реализация метода saveAs</span></li>\r\n        <li><a href="https://github.com/Diokuz/baron" target="_blank">baron</a><span class="md_muted_color">, компонент управления полосами прокрутки</span></li>\r\n        <li><a href="https://github.com/ded/qwery" target="_blank">qwery</a><span class="md_muted_color">, движок селекторов</span></li>\r\n        <li><a href="https://github.com/ded/bonzo" target="_blank">bonzo</a><span class="md_muted_color">, утилиты DOM</span></li>\r\n        <li><a href="https://github.com/fat/bean" target="_blank">bean</a><span class="md_muted_color">, библиотека событий для javascript</span></li>\r\n    </ul>\r\n\r\n    <h3>Графика</h3>\r\n    <ul>\r\n        <li><a href="https://fortawesome.github.io/Font-Awesome/" target="_blank">fontawesome</a><span class="md_muted_color">, набор иконок и стилей CSS</span></li>\r\n        <li><a href="http://fontastic.me/" target="_blank">fontastic</a><span class="md_muted_color">, еще один набор иконок и стилей</span></li>\r\n    </ul>\r\n\r\n    <p>&nbsp;</p>\r\n    <h2><i class="fa fa-question-circle"></i> Вопросы</h2>\r\n    <p>Если обнаружили ошибку, пожалуйста,\r\n        <a href="https://github.com/oknosoft/metastore/issues/new" target="_blank">зарегистрируйте вопрос в GitHub</a> или\r\n        <a href="http://www.oknosoft.ru/metadata/#page-118" target="_blank">свяжитесь с разработчиком</a> напрямую<br />&nbsp;</p>\r\n\r\n</div>',"cart.html":'<div class="md_column1300">\r\n\r\n    <h1><i class="fa fa-shopping-cart"></i> Корзина</h1>\r\n\r\n    <div class="md_column320" style="width: 67%; padding: 0 8px 0 0; margin-left: -8px;">\r\n        <div name="cart_dataview" style="height: 360px; width: 100%;"></div>\r\n    </div>\r\n\r\n    <div class="md_column320" name="cart_order" style="padding: 0; width: 26%; min-width: 262px;">\r\n\r\n        <table class="aligncenter" style="line-height: 40px">\r\n            <tr name="top1">\r\n                <td style="border-bottom: 1px #ddd dashed;">Товары (2)</td>\r\n                <td align="right" style="border-bottom: 1px #ddd dashed;">1300</td>\r\n            </tr>\r\n\r\n            <tr vertical-align: baseline;>\r\n                <td>Всего:</td>\r\n                <td name="top2" align="right" style="font-size: 2em;">1300 <i class="fa fa-rub" style="font-size: smaller"></i></td>\r\n            </tr>\r\n\r\n            <tr>\r\n                <td colspan="2">\r\n                    <a href="#" class="dropdown_list" style="display: inline-block; line-height: normal" title="Наличие в магазинах">Можно забрать сегодня</a>\r\n                </td>\r\n            </tr>\r\n\r\n            <tr>\r\n                <td>Бонусных рублей:</td>\r\n                <td name="top3" align="right">190</td>\r\n            </tr>\r\n\r\n            <tr>\r\n                <td colspan="2">\r\n                    <button name="order_order" class="md_btn btn-red btn-fluid">Оформить заказ</button>\r\n                </td>\r\n            </tr>\r\n\r\n            <tr>\r\n                <td colspan="2">\r\n                    <p style="margin: 0">Оплатите онлайн – получите скидку 5%</p>\r\n                </td>\r\n            </tr>\r\n\r\n            <tr class="dv_icon_card">\r\n                <td><i class="fa fa-square-o fa-lg"></i> Оплатить картой</td>\r\n                <td align="right"><i class="fa fa-cc-visa"></i>&nbsp;<i class="fa fa-cc-mastercard"></i></td>\r\n            </tr>\r\n\r\n        </table>\r\n\r\n    </div>\r\n\r\n</div>',"cart_order_top1.html":'<td style="border-bottom: 1px #ddd dashed;">Товары (#count#)</td>\r\n<td align="right" style="border-bottom: 1px #ddd dashed;">#amount#</td>',"cart_order_top2.html":'#amount# <i class="fa fa-rub" style="font-size: smaller"></i>',"checkout.html":'<div class="clipper wdg_product_checkout">\r\n    <div class="scroller">\r\n        <div class="container">\r\n\r\n            <!-- РАЗДЕЛ 1 - выбор способа оплаты -->\r\n            <div class="header">\r\n                <div class="header__title" name="header">\r\n                    <span name="title">Способ оплаты</span>\r\n                </div>\r\n            </div>\r\n            <div name="billing_kind" style="padding: 10px; background: #f5f5f5;">\r\n\r\n                <ul class="margin-0 padding-0 billing-systems inline-ul min-width-800px">\r\n                    <li class="margin-right-2px active">\r\n                        <a class="width-104px height-66px display-block border-radius-5px bs-logo logo-visa" href="#"></a>\r\n                        Банковские<br>карты\r\n                        <b class="z-index-2"></b>\r\n                    </li>\r\n                    <li class="margin-right-2px">\r\n                        <a class="width-104px height-66px display-block border-radius-5px bs-logo logo-pcards" href="#"></a>\r\n                        Наличные<br>при получении\r\n                        <b class="z-index-2"></b>\r\n                    </li>\r\n                    <li class="margin-right-2px">\r\n                        <a class="width-104px height-66px display-block border-radius-5px bs-logo logo-qiwi" href="#"></a>\r\n                        QIWI <br> Кошелек\r\n                        <b class="z-index-2"></b>\r\n                    </li>\r\n                    <li class="margin-right-2px">\r\n                        <a class="width-104px height-66px display-block border-radius-5px bs-logo logo-webmoney" href="#"></a>\r\n                        WebMoney<br>WMR, WMZ\r\n                        <b class="z-index-2"></b>\r\n                    </li>\r\n                    <li class="margin-right-2px">\r\n                        <a class="width-104px height-66px display-block border-radius-5px bs-logo logo-ymoney" href="#"></a>\r\n                        Яндекс <br> Деньги\r\n                        <b class="z-index-2"></b>\r\n                    </li>\r\n                    <li class="margin-right-2px">\r\n                        <a class="width-104px height-66px display-block border-radius-5px bs-logo logo-cash" href="#"></a>\r\n                        Безналичный<br>платеж\r\n                        <b class="z-index-2"></b>\r\n                    </li>\r\n                    <li class="margin-right-2px">\r\n                        <a class="width-104px height-66px display-block border-radius-5px bs-logo logo-robox" href="#"></a>\r\n                        Другие <br> способы оплаты\r\n                        <b class="z-index-2"></b>\r\n                    </li>\r\n                </ul>\r\n\r\n                <div class="opacity-03 hr bg-666">&nbsp;</div>\r\n\r\n                <div class="billing-systems-container">\r\n                    <div class="billing-system visa-container">\r\n                        <table border="0" cellpadding="0" cellspacing="0" class="text_tbl">\r\n                            <tbody><tr>\r\n                                <td>\r\n                                    <p class="tit">Моментальная оплата платежными картами Visa и Mastercard</p>\r\n                                </td>\r\n                            </tr>\r\n                            </tbody></table>\r\n                    </div>\r\n                    <div class="billing-system qiwi-container hide">\r\n                        <table border="0" cellpadding="0" cellspacing="0" class="text_tbl">\r\n                            <tbody><tr>\r\n                                <td>\r\n                                    <p class="tit">\r\n                                        Моментальная оплата с помощью <a href="https://qiwi.com/landing/other.action" target="_blank">QIWI кошелька</a> (Россия).<br>\r\n                                        1. Введите номер QIWI Кошелька (номер сотового телефона)<br>\r\n                                        2. Оплатите автоматически созданный счет на оплату: на сайте <a href="https://qiwi.com/landing/other.action" target="_blank">QIWI Кошелька</a>, терминале QIWI, с помощью приложения для социальных сетей или мобильного <a href="https://w.qiwi.com/applications/main.action" target="_blank">телефона</a>.<br>\r\n                                        QIWI Кошелек легко <a href="https://w.qiwi.com/replenish/main.action" target="_blank">пополнить</a> в терминалах QIWI и партнеров, банковскими картами, салонах сотовой связи, супермаркетах, банкоматах или через интернет-банк. Совершать платежи Вы можете не только со счета QIWI Кошелька, но и банковской картой, наличными, а также с лицевого счета мобильного телефона.\r\n                                    </p>\r\n                                </td>\r\n                            </tr>\r\n                            <tr>\r\n                            </tr></tbody></table>\r\n                    </div>\r\n                    <div class="billing-system webmoney-container hide">\r\n                        <table border="0" cellpadding="0" cellspacing="0" class="text_tbl">\r\n                            <tbody><tr>\r\n                                <td>\r\n                                    <p class="tit">Моментальная оплата через систему WebMoney в валютах WMZ и WMR.</p>\r\n                                </td>\r\n                            </tr>\r\n                            </tbody></table>\r\n                    </div>\r\n                    <div class="billing-system ymoney-container hide">\r\n                        <table border="0" cellpadding="0" cellspacing="0" class="text_tbl">\r\n                            <tbody><tr>\r\n                                <td>\r\n                                    <p class="tit ym-descriptor PC ">\r\n                                        Оплатить заказ можно электронными деньгами Яндекс.Деньги, а также банкоматах Сбербанка и салонах сотовой связи («Евросеть», «Связной»)\r\n                                    </p>\r\n                                </td>\r\n                            </tr>\r\n                            </tbody></table>\r\n                    </div>\r\n                    <div class="billing-system pcards-container hide">\r\n                        <table border="0" cellpadding="0" cellspacing="0" class="text_tbl">\r\n                            <tbody><tr>\r\n                                <td><p class="tit">Оплата через курьера при получении заказа</p></td>\r\n                            </tr>\r\n                            </tbody></table>\r\n                    </div>\r\n                    <div class="billing-system cash-container hide">\r\n                        <table border="0" cellpadding="0" cellspacing="0" class="text_tbl">\r\n                            <tbody><tr>\r\n                                <td><p class="tit">Безналичная оплата для Юридических лиц</p></td>\r\n                            </tr>\r\n                            </tbody></table>\r\n                    </div>\r\n                    <div class="billing-system robox-container hide">\r\n                        <table border="0" cellpadding="0" cellspacing="0" class="text_tbl">\r\n                            <tbody><tr>\r\n                                <td>\r\n                                    <p class="tit">\r\n                                        Вы можете мгновенно оплатить заказ различными электронными валютами при помощи сервиса ROBOKASSA.<br>\r\n                                        При помощи этой службы вы можете пополнить счет через терминалы мгновенной оплаты, через систему денежных переводов Contact,\r\n                                        с помощью кредитных карт, а также многими видами электронных денег\r\n                                    </p>\r\n                                </td>\r\n                            </tr>\r\n                            </tbody></table>\r\n                    </div>\r\n                </div>\r\n\r\n            </div>\r\n\r\n\r\n            <!-- РАЗДЕЛ 2 - доставка -->\r\n            <div class="header">\r\n                <div class="header__title header__title_state_fixed">Доставка</div>\r\n            </div>\r\n            <div name="delivery">\r\n                <p class="text">Выбор способа доставки</p>\r\n            </div>\r\n\r\n\r\n            <!-- РАЗДЕЛ 3 - завершение -->\r\n            <div class="header">\r\n                <div class="header__title header__title_state_fixed">Оформить заказ</div>\r\n            </div>\r\n            <div name="order">\r\n                <p class="text"><i class="fa fa-info-circle fa-lg"></i> Оформление заказа отключено в демо-версии</p>\r\n            </div>\r\n\r\n            <div class="load" style="height: 0px;">\r\n                <div class="load__value" style="width: 0%;"></div>\r\n            </div>\r\n\r\n        </div>\r\n    </div>\r\n\r\n    <div class="scroller__track">\r\n        <div class="scroller__bar" style="height: 26px; top: 0px;"></div>\r\n    </div>\r\n\r\n</div>',"content.html":'<div class="md_column1300">\r\n    <h1><i class="fa fa-opencart"></i> 1с интернет магазин MetaStore</h1>\r\n    <p class="small-margin">\r\n        Перед вами - стандартная конфигурация 1С:Управление торговлей, редакции 11.2, к которой подключен интерфейс интернет-магазина.\r\n        Все "внутренности", включая схему данных и бизнес-логику используются родные, 1С-ные, без изменений. Для решения задач интернет-тогргвли,\r\n        реализованы веб-формы поиска и просмотра номенклатуры, добавлен инструмент сравнения свойств товаров и корзина покупок.\r\n    </p>\r\n    <div class="md_column300">\r\n        <p class="text-center small-margin">\r\n            <!-- Start round icon -->\r\n            <a href="#" class="apex-icon-round">\r\n            <span class="apex-icon">\r\n                <i class="apex-icon-1c"></i>\r\n            </span>\r\n                <span class="apex-icon-title">Типовая 1С</span>\r\n            </a>\r\n            <!-- End round icon -->\r\n            MetaStore - это веб-интерфейс<br />\r\n            к типовым конфигурациям 1С, реализующий функциональность интернет-магазина\r\n        </p>\r\n    </div>\r\n\r\n    <div class="md_column300">\r\n        <p class="text-center small-margin">\r\n            <!-- Start round icon -->\r\n            <a href="#" class="apex-icon-round">\r\n            <span class="apex-icon">\r\n                <i class="apex-icon-connect"></i>\r\n            </span>\r\n                <span class="apex-icon-title">Готовое решение</span>\r\n            </a>\r\n            <!-- End round icon -->\r\n            Подключается в один клик:<br />\r\n            1С:Управление торговлей,<br />\r\n            1С:Комплексная автоматизация,<br />\r\n            1С:ERP Управление предприятием\r\n        </p>\r\n    </div>\r\n\r\n    <div class="md_column300">\r\n        <p class="text-center small-margin">\r\n            <!-- Start round icon -->\r\n            <a href="#" class="apex-icon-round">\r\n            <span class="apex-icon">\r\n                <i class="apex-icon-equilizer"></i>\r\n            </span>\r\n                <span class="apex-icon-title">Простота настроек</span>\r\n            </a>\r\n            <!-- End round icon -->\r\n            Иерархия, свойства номенклатуры,<br />остатки и цены, настраиваются<br />в привычных формах 1С\r\n        </p>\r\n    </div>\r\n\r\n    <div class="md_column300">\r\n        <p class="text-center small-margin">\r\n            <!-- Start round icon -->\r\n            <a href="#" class="apex-icon-round">\r\n            <span class="apex-icon">\r\n                <i class="fa fa-github-alt" style="line-height: 78px;"></i>\r\n            </span>\r\n                <span class="apex-icon-title">Открытый код</span>\r\n            </a>\r\n            <!-- End round icon -->\r\n            Разработано на базе <a href="http://www.oknosoft.ru/metadata/" target="_blank">Metadata.js</a><br />\r\n            Исходный код и документация<br />доступны на <a href="https://github.com/oknosoft/metastore" target="_blank">GitHub <i class="fa fa-github-alt"></i></a>\r\n            <br />&nbsp;\r\n        </p>\r\n    </div>\r\n\r\n\r\n    <div style="padding: 12px 0 0 0; clear: both; display: inline-block; width: 100%">\r\n\r\n        <div class="md_column320">\r\n            <img class="aligncenter" src="templates/imgs/print_order.png" style="width: 100%">\r\n        </div>\r\n\r\n        <div class="md_column320">\r\n            <h2>Ключевые особенности и преимущества</h2>\r\n            <ul>\r\n                <li class="small-margin">Информация об остатках, оплатах и заказах, доступна в личном кабинете на сайте в реальном времени — никаких обменов между сайтом и 1С не требуется, так как сайт — это и есть 1С</li>\r\n                <li class="small-margin">Библиотека является расширением типовых конфигураций 1С и максимально использует методические и программные наработки, накопленные фирмой 1С и её партнерами</li>\r\n                <li class="small-margin">В личном кабинете, клиенту доступны для просмотра все первичные документы, связанные с его покупками (счета, оплаты, отгрузки и возвраты)</li>\r\n            </ul>\r\n\r\n            <h3>Для партнеров и программитов 1С</h3>\r\n            <ul>\r\n                <li class="small-margin">Настройка бизнес-логики под требования заказчика, выполняется в привычном конфигураторе с использованием знакомых объектов типовых решений 1С</li>\r\n                <li class="small-margin">Опыт разработки на javascript не повредит, но в серверной части проекта язык javascript не используется и для её поддержки и адаптации, специальных знаний веб-технологий не требуется</li>\r\n            </ul>\r\n\r\n            <h3>Для веб-студий и программитов javascript</h3>\r\n            <ul>\r\n                <li class="small-margin">MetaStore базируется на библиотеке <a href="https://github.com/oknosoft/metadata.js" target="_blank">metadata.js</a>, которая предоставляет frontend-разрабочтику высокоуровневые javascript-объекты, упрощающие взаимодействие с 1С</li>\r\n                <li class="small-margin">Опыт разработки на 1С не повредит, но в клиентской части проекта язык 1С не используется и для её поддержки и адаптации, специальных знаний 1С не требуется</li>\r\n            </ul>\r\n\r\n        </div>\r\n\r\n    </div>\r\n\r\n\r\n    <div style="padding: 12px 0 0 0; clear: both; display: inline-block; width: 100%">\r\n\r\n        <div class="md_column320">\r\n            <h3>Для пользователей</h3>\r\n            <ul>\r\n                <li class="small-margin">Управление настройками магазина, свойствами и категориями номенклатуры, правилами ценообразования, заказами, оплатами и доставками, происходит в привычных формах 1С. Никакого двойного ввода данных, импорта и экспорта не требуется</li>\r\n                <li class="small-margin">На сайте теперь можно использовать любые данные, доступные в 1С, что повышает функциональность и привлекательность интернет-магазина</li>\r\n                <li class="small-margin">Интеграция с каталогом Яндекс.Маркет\r\n                    <ul>\r\n                        <li>Импорт категорий и свойств товаров</li>\r\n                        <li>Показ отзывов с Яндекс.Маркета в карточке товара интегрнет-магазина</li>\r\n                    </ul>\r\n                </li>\r\n            </ul>\r\n\r\n            <h3>Для всех</h3>\r\n            <ul>\r\n                <li class="small-margin">Надёжность сервиса. Библиотека <a href="https://github.com/oknosoft/metadata.js" target="_blank">metadata.js</a> берёт на себя вопросы синхронизации данных между сайтом и 1С\r\n                    <ul>\r\n                        <li>В штатном режиме, когда сервер 1С доступен, выполняется прямое чтение и запись данных в 1С</li>\r\n                        <li>При недоступности сервера 1С, данные кешируются в промежуточном прокси на Node.js</li>\r\n                    </ul>\r\n                </li>\r\n                <li class="small-margin">Масштабируемость\r\n                    <ul>\r\n                        <li>Для небольших сайтов с посещаемостью до 1000 человек в день, с обработкой запросов справится единственный экземпляр сервера 1С</li>\r\n                        <li>Для крупных проектов можно задействовать балансировщики нагрузки и отказоустойчивые кластеры</li>\r\n                    </ul>\r\n                </li>\r\n                <li class="small-margin">Скорость работы\r\n                    <ul>\r\n                        <li>В MetaStore задействованы возможности современных браузеров и оптимизирован трафик между клиентом и сервером</li>\r\n                    </ul>\r\n                </li>\r\n                <li class="small-margin">Функциональность\r\n                    <ul>\r\n                        <li>Использование на сайте модели данных 1С, отточенной многолетним опытом автоматизации крупных торговых предприятий, позволяет реализовать функциональный интерфейс, нацеленный на удобство клиентов</li>\r\n                    </ul>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n\r\n        <div class="md_column320">\r\n            <img class="aligncenter" src="templates/imgs/product_card.png" style="width: 100%">\r\n        </div>\r\n\r\n    </div>\r\n\r\n\r\n    <div style="padding: 12px 0 0 0; clear: both; display: inline-block; width: 100%">\r\n\r\n        <div class="md_column320">\r\n            <img class="aligncenter" src="templates/imgs/phone-2.png" alt="phone" width="332" height="409">\r\n        </div>\r\n\r\n        <div class="md_column320">\r\n            <h2 class="light">Поддержка мобильных устройств</h2>\r\n            <ul>\r\n                <li class="small-margin">Адаптивная разметка в зависимости от размеров экрана</li>\r\n                <li class="small-margin">Полноэкранный режим и события смены ориентации устройства</li>\r\n                <li>Кеширование данных и экономия трафика обеспечивают комфортную работу при плохой связи</li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n\r\n\r\n</div>',
